...
const InstallerOrders = ({ navigation, user }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            // Installers likely want to focus on delivered/processing orders, 
            // but we fetch all for flexibility for now.
            setOrders(data);
        } catch (error) {
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <View style={styles.searchBar}>
                    ...
                    <TextInput
                        placeholder="Search orders to install..."
            ...
            >
                <Text style={styles.sectionLabel}>AVAILABLE INSTALLATION ORDERS</Text>
                            ...
                            <ScrollView showsVerticalScrollIndicator={false}>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        ...
                                        navigation.navigate('SubmissionForm', { order });
                                    }}
                                >
...
export default InstallerOrders;
